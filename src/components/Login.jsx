...
export default function Login() {
  ...
  const Handlechange = (event) => {
    ...
    setForm((prevData) => ({ ...prevData, [key_name]: value }));
  };
      ...
      fetch(URL_ENDPOINT, {
        ...
        .then((res) => {
          if (res.status_code === 200) {
            ...
            const name = res.student_data[0]["student_name"];
    ...
    <div className="bg-[#131313] h-screen flex">
      ...
      <div className="p-2 justify-center flex flex-col w-full items-center">
        ...
        <form
          ...
          className="space-y-2 p-2 sm:p-5 sm:w-1/2 lg:w-1/3 border border-gray-600 rounded-2xl flex flex-col gap-2 items-center w-full"
          action=""
        >
          ...
          <input
            ...
            value={form.name}
            className="bg-[#212121] rounded-2xl outline-none w-full p-5 text-white"
          ...
          <button
            ...
            className="bg-linear-to-r from bg-white font-semibold w-full rounded-2xl text-black p-4 "
          >
            Register
          </button>
        </form>
